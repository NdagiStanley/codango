...
class ActivityMiddleWareTest(TestCase):
    ...
    def test_that_middleware_updates_context_with_categories(self):
        ...
        """
        response = self.client.get(reverse('user_profile', kwargs={
        ...
        # assert for popular resources
        popular_resources = response.context_data.get('popular')
        self.assertIsNotNone(popular_resources)
